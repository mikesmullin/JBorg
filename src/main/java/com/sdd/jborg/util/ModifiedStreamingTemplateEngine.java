...
/**
 * This class is 99% copy-paste of groovy.text.StreamingTemplateEngine;
 * We only modified it so that the JSP style syntax is the only option.
 * This helps prevent conflicts with symbols like $ which are common in
 * the configuration files we are templating.
 */
public class ModifiedStreamingTemplateEngine
	extends TemplateEngine
{
	 ...
	 */
	public ModifiedStreamingTemplateEngine() {
		this(ModifiedStreamingTemplateEngine.class.getClassLoader());
	}
	 ...
	 */
	public ModifiedStreamingTemplateEngine(ClassLoader parentLoader) {
